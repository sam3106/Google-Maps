  ...
  function createMarker(place) {
    ...
    google.maps.event.addListener(marker, 'click', function() {
      ...
      geocoder.geocode({'placeId': place.place_id},function(results, status){
        ...
        var dirURL="https://www.google.com/maps/dir/?api=1&destination="+results[0].geometry.location.lat().toString()+","+results[0].geometry.location.lng().toString();
        
        if (status === 'OK') {
          if (results[0]) {
          address="<strong>"+results[0].formatted_address+"</strong><br><a  target='_blank' href='"+dirURL+"'> Get Directions </a>";
          }
          else{
